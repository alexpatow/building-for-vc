...
**For small funds: Start with Postgres**. If you're tracking tens of thousands of companies (not hundreds of thousands), Postgres works fine. It's simpler and cheaper than specialized warehouses, your team already knows it, and you can use the same database for applications and analytics.
