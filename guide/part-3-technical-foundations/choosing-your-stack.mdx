...
At Inflection, our default stack for web applications and APIs was:
...
Use boring, proven technology that lets you ship fast. At Inflection, that was Next.js, TypeScript, Postgres, and Vercel. For data work, Python when you need it.
