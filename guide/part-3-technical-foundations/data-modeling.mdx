...
Use dbt (covered in [Data Warehousing](/guide/part-3-technical-foundations/data-warehousing)) to transform append-only staging tables into intermediate tables with current values:
...
Decide which source wins for each field, based on your assessment of data quality (covered in [Data Quality](/guide/part-3-technical-foundations/data-quality)):
