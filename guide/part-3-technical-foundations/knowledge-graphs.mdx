...
**Key lesson from EQT**: They built CompanyKG on top of their existing Motherbrain platform. They didn't start with a graph database. They modeled their data properly first, then built the knowledge graph as a layer on top. This is the right approach for most funds.
