...
[Alex Patow](https://www.linkedin.com/in/alexpatow/) has been building in VC since 2020. He runs [Boolean Industries](https://boolean.industries), a consulting firm helping VC funds build data pipelines, deal flow systems, portfolio analytics, and the internal tools that power investment decisions. Previously, he started at [EQT](https://eqtgroup.com/) as part of the [Motherbrain platform](https://eqtgroup.com/about/motherbrain), worked closely with deal teams in EQT's PE business as a founding member of Motherbrain Labs, and built core infrastructure at [Inflection](https://inflection.fund/), a pre-seed/seed deep tech VC fund.
