...
<CardGroup cols={2}>
  ...
  <Card title="Inflection - svrgn" icon="envelope" href="https://svrgn.substack.com/">
    On engineering moonshots and deep technology. Occasional posts by Alex Patow about Inflection's
...
| ------------------------------------------------- | --------------------------- | -------------------------------------------------------------------------------------------------------------- |
| **The Business of Venture Capital** (3rd Edition) | Mahendra Ramsinghani        | Comprehensive overview of fund structures, legal frameworks, and the LP-GP relationship                        |
...
<AccordionGroup>
  ...
  <Accordion title="VC Decision-Making & Biases">
    - [Machine Learning About Venture Capital Choices](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4035930) — Analyzes VC investment decisions through predictive modeling using French administrative data. Finds that VCs overweight entrepreneur characteristics (elite schools, gender, location) relative to their actual impact on performance, contributing to industry narrowness. By Victor Lyonnet and Léa H. Stern.

    - [Venture Capital Start-up Selection](https://bfi.uchicago.edu/wp-content/uploads/2025/03/BFI_WP_2025-38.pdf) — Studies 8,000+ sourced deals from one early-stage VC. Finds VCs overweight team factors in initial decisions despite market and product being better predictors of long-term success (funding >$10M+). Team explains initial $1M+ funding but not larger outcomes. By Young Soo Jang and Steven N. Kaplan (NBER Working Paper, Feb 2025).

    - [Venture Capitalists' Decision-Making Under Changing Resource Availability](https://repository.upenn.edu/handle/20.500.14332/60297) — Qualitative study examining how VCs' evaluative criteria shift during economic changes and resource scarcity. Based on interviews with 14 Bay Area VCs, explores objective vs. subjective selection criteria and whether VCs act as responsible fiduciaries under different market conditions. By Noah Pettit (UPenn EdD Dissertation, 2024).
...
<CardGroup cols={2}>
  ...
  <Card title="VC Day by Vestberry" icon="calendar" href="https://vcday.vestberry.com/">
    Conference focused on VC operations and technology
  </Card>
</CardGroup>
...
Building a VC tech team? Looking for your next role in VC infrastructure?

<Info>
  If you're hiring in this space, reach out to [Alex](https://www.linkedin.com/in/alexpatow/) —
  happy to add opportunities here.
</Info>
