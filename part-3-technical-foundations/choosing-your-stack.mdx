...
**Postgres is the right database for most VC tools**. It's relational (your data is structured: companies, deals, people, relationships), it's mature, it scales far beyond what you'll need, and as covered in [Data Warehousing](/part-3-technical-foundations/data-warehousing), it's adequate as a data warehouse for small to mid-size funds before you need Snowflake or BigQuery.
...
**Data transformations in the warehouse**. If you're using dbt for data transformations (covered in [Data Warehousing](/part-3-technical-foundations/data-warehousing)), you'll write Python for custom models that run in Snowpark (Snowflake), BigQuery DataFrames, or PySpark. The data warehouse ecosystem is Python-native.
...
**The exception**: If you have specific compliance requirements ([Security and Compliance](/part-3-technical-foundations/security-and-compliance) covers security and compliance), you might need self-hosted infrastructure for data residency or audit reasons. But this is rare for most funds and work with your CISO or compliance officer to find a path forward. Default to managed services.
...
- A validation library (Zod for TypeScript, covered in [Integrations and APIs](/part-3-technical-foundations/integrations-and-apis)) is essential for API integrations
