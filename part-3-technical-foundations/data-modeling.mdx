...
This separation is fundamental to building VC software that works. If you try to embed deals into the companies table or vice versa, you'll create a mess that's hard to query and impossible to extend. As emphasized in [CRM and Deal Flow](/part-2-tech-stack/crm-and-deal-flow) on CRM, this distinction is one of the most important architectural decisions you'll make.
...
Use dbt (covered in [Data Warehousing](/part-3-technical-foundations/data-warehousing)) to transform append-only staging tables into intermediate tables with current values:
...
Decide which source wins for each field, based on your assessment of data quality (covered in [Data Quality](/part-3-technical-foundations/data-quality)):
